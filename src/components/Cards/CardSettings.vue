  ...
  >
    <div class="px-6 py-6 mb-0 bg-white rounded-t">
      <div class="flex justify-between text-center">
        <h6 class="text-xl font-bold text-blueGray-700">Setting Card</h6>
        <button
          class="px-4 py-2 mr-1 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear bg-black rounded shadow outline-none active:bg-blueGray-800 hover:shadow-md focus:outline-none"
          type="button"
        >
          Settings
        </button>
