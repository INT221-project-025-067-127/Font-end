<template>
  <div class="container h-full px-4 pt-32 mx-auto">
        ...
        >
          <div class="px-6 py-6 mb-0 rounded-t">
            ...
            <div class="text-center btn-wrapper">
              <button
                class="inline-flex items-center px-4 py-2 mb-1 mr-2 text-xs font-normal uppercase transition-all duration-150 ease-linear bg-white rounded shadow outline-none active:bg-blueGray-50 text-blueGray-700 focus:outline-none hover:shadow-md"
                type="button"
              >
              ...
              <button
                class="inline-flex items-center px-4 py-2 mb-1 mr-1 text-xs font-normal uppercase transition-all duration-150 ease-linear bg-white rounded shadow outline-none active:bg-blueGray-50 text-blueGray-700 focus:outline-none hover:shadow-md"
                type="button"
              >
